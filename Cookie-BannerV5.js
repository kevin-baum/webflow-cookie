...
(function() {
    ...
    const injectCSS = () => {
        ...
        style.textContent = `
            ...
            .cookie-list{background:#f7fafc;border-radius:8px;padding:16px;margin:16px 0;font-size:13px;border:1px solid #e2e8f0;max-height:450px;overflow-y:auto}
            .cookie-table{width:100%;border-collapse:collapse;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 4px rgba(0,0,0,.08)}
            .cookie-table thead{background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:#fff}
            .cookie-table thead th{padding:12px 10px;text-align:left;font-weight:600;font-size:13px;border-bottom:2px solid #e2e8f0}
            .cookie-table tbody tr{border-bottom:1px solid #e2e8f0;transition:background .2s ease}
            .cookie-table tbody tr:hover{background:#f7fafc}
            .cookie-table tbody tr:last-child{border-bottom:none}
            .cookie-table td{padding:12px 10px;vertical-align:top;font-size:13px;line-height:1.5}
            .cookie-table td:first-child{font-weight:600;color:#2d3748}
            .cookie-table .desc-cell{color:#718096;font-size:12px;line-height:1.6}
            .table-icon{display:inline-flex;align-items:center;gap:6px}
