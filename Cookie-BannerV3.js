...
(function() {
    ...
    const ICONS = {
        ...
        // Zusätzliche Icons für Cookie-Details
        clock: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" style="width:14px;height:14px;color:#718096;display:inline-block;vertical-align:middle"><path fill-rule="evenodd" d="M8 15A7 7 0 108 1a7 7 0 000 14zm1-7.5V4a.5.5 0 00-1 0v4a.5.5 0 00.146.354l2.5 2.5a.5.5 0 00.708-.708L9 7.5z" clip-rule="evenodd" /></svg>',
        document: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" style="width:14px;height:14px;color:#718096;display:inline-block;vertical-align:middle"><path fill-rule="evenodd" d="M4 2a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H4zm0 1h8a1 1 0 011 1v8a1 1 0 01-1 1H4a1 1 0 01-1-1V4a1 1 0 011-1zm1 2.5a.5.5 0 01.5-.5h5a.5.5 0 010 1h-5a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h5a.5.5 0 010 1h-5a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h3a.5.5 0 010 1h-3a.5.5 0 01-.5-.5z" clip-rule="evenodd" /></svg>',
        building: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" style="width:14px;height:14px;color:#718096;display:inline-block;vertical-align:middle"><path fill-rule="evenodd" d="M2 2.5A1.5 1.5 0 013.5 1h9A1.5 1.5 0 0114 2.5V15h-1V2.5a.5.5 0 00-.5-.5h-9a.5.5 0 00-.5.5V15H2V2.5zM4.5 5a.5.5 0 01.5-.5h1a.5.5 0 01.5.5v1a.5.5 0 01-.5.5H5a.5.5 0 01-.5-.5V5zm3 0a.5.5 0 01.5-.5h1a.5.5 0 01.5.5v1a.5.5 0 01-.5.5H8a.5.5 0 01-.5-.5V5zm3.5-.5a.5.5 0 00-.5.5v1a.5.5 0 00.5.5h1a.5.5 0 00.5-.5V5a.5.5 0 00-.5-.5h-1zM4.5 8a.5.5 0 01.5-.5h1a.5.5 0 01.5.5v1a.5.5 0 01-.5.5H5a.5.5 0 01-.5-.5V8zm3.5-.5a.5.5 0 00-.5.5v1a.5.5 0 00.5.5h1a.5.5 0 00.5-.5V8a.5.5 0 00-.5-.5H8zm2.5.5a.5.5 0 01.5-.5h1a.5.5 0 01.5.5v1a.5.5 0 01-.5.5h-1a.5.5 0 01-.5-.5V8zM5.5 11a.5.5 0 00-.5.5v3h2v-3a.5.5 0 00-.5-.5h-1zm4 0a.5.5 0 00-.5.5v3h2v-3a.5.5 0 00-.5-.5h-1z" clip-rule="evenodd" /></svg>',
        target: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" style="width:14px;height:14px;color:#718096;display:inline-block;vertical-align:middle"><path fill-rule="evenodd" d="M8 15A7 7 0 108 1a7 7 0 000 14zm0-2A5 5 0 108 3a5 5 0 000 10zm0-2a3 3 0 100-6 3 3 0 000 6zm0-2a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" /></svg>',
        lightbulb: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" style="width:14px;height:14px;color:#4299e1;display:inline-block;vertical-align:middle"><path fill-rule="evenodd" d="M8 1a5 5 0 00-3.5 8.5c.5.5.5 1 .5 1.5v1a1 1 0 001 1h4a1 1 0 001-1v-1c0-.5 0-1 .5-1.5A5 5 0 008 1zM7 14v1h2v-1H7z" clip-rule="evenodd" /></svg>',
        xCircle: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" style="width:14px;height:14px;color:#e53e3e;display:inline-block;vertical-align:middle"><path fill-rule="evenodd" d="M8 15A7 7 0 108 1a7 7 0 000 14zm2.854-10.854a.5.5 0 010 .708L8.707 7l2.147 2.146a.5.5 0 01-.708.708L8 7.707l-2.146 2.147a.5.5 0 01-.708-.708L7.293 7 5.146 4.854a.5.5 0 01.708-.708L8 6.293l2.146-2.147a.5.5 0 01.708 0z" clip-rule="evenodd" /></svg>',
        chartBar: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" style="width:14px;height:14px;color:#4299e1;display:inline-block;vertical-align:middle"><path d="M1.5 13.5A.5.5 0 012 13h12a.5.5 0 010 1H2a.5.5 0 01-.5-.5zM3 11.5a.5.5 0 01.5-.5h1a.5.5 0 01.5.5v2a.5.5 0 01-.5.5h-1a.5.5 0 01-.5-.5v-2zm4-3a.5.5 0 01.5-.5h1a.5.5 0 01.5.5v5a.5.5 0 01-.5.5h-1a.5.5 0 01-.5-.5v-5zm4-4a.5.5 0 01.5-.5h1a.5.5 0 01.5.5v9a.5.5 0 01-.5.5h-1a.5.5 0 01-.5-.5v-9z" /></svg>'
    };
    ...
    const injectCSS = () => {
        ...
        style.textContent = `
            ...
            .cookie-list{background:#f7fafc;border-radius:8px;padding:16px;margin:16px 0;font-size:13px;border:1px solid #e2e8f0;max-height:400px;overflow-y:auto}
            .cookie-item{background:#fff;border-left:4px solid #4299e1;border-radius:8px;padding:16px;margin:12px 0;box-shadow:0 2px 4px rgba(0,0,0,.08);transition:all .2s ease}
            .cookie-item:hover{box-shadow:0 4px 8px rgba(0,0,0,.12);transform:translateX(2px)}
            .cookie-name{font-weight:700;color:#2d3748;font-size:15px;margin-bottom:10px;padding-bottom:8px;border-bottom:2px solid #e2e8f0;word-break:break-word}
            .cookie-row{display:grid;grid-template-columns:120px 1fr;gap:12px;margin:8px 0;font-size:13px;line-height:1.5;align-items:start}
            .cookie-label{color:#718096;font-weight:600}
            .cookie-value{color:#2d3748;word-break:break-word}
            .cookie-desc{background:#e6fffa;color:#234e52;padding:10px 12px;border-radius:6px;margin-top:10px;font-size:12px;line-height:1.6;border-left:3px solid #4299e1}
    ...
    CookieScanner.prototype.generateHTML = function(category) {
        ...
        for (var i = 0; i < list.length; i++) {
            ...
            html += '<div class="cookie-name"><span style="display:inline-flex;align-items:center;gap:8px">' + ICONS.cookie + ' <span>' + this.escapeHtml(c.name) + '</span></span></div>';
            html += '<div class="cookie-row">';
            html += '<span class="cookie-label" style="display:inline-flex;align-items:center;gap:6px">' + ICONS.document + ' <span>Typ:</span></span>';
            html += '<span class="cookie-value">' + this.escapeHtml(c.type) + '</span>';
            html += '</div>';
            html += '<div class="cookie-row">';
            html += '<span class="cookie-label" style="display:inline-flex;align-items:center;gap:6px">' + ICONS.clock + ' <span>Dauer:</span></span>';
            html += '<span class="cookie-value">' + this.escapeHtml(c.duration) + '</span>';
            html += '</div>';
            html += '<div class="cookie-row">';
            html += '<span class="cookie-label" style="display:inline-flex;align-items:center;gap:6px">' + ICONS.building + ' <span>Anbieter:</span></span>';
            html += '<span class="cookie-value">' + this.escapeHtml(c.tool || 'Unbekannt') + '</span>';
            html += '</div>';
            if (c.purpose && c.purpose !== c.desc) {
                html += '<div class="cookie-row">';
                html += '<span class="cookie-label" style="display:inline-flex;align-items:center;gap:6px">' + ICONS.target + ' <span>Zweck:</span></span>';
                html += '<span class="cookie-value">' + this.escapeHtml(c.purpose) + '</span>';
                html += '</div>';
            }
            html += '<div class="cookie-desc"><span style="display:inline-flex;align-items:start;gap:6px">' + ICONS.lightbulb + ' <span><strong>Beschreibung:</strong> ' + this.escapeHtml(c.desc) + '</span></span></div>';
            html += '</div>';
        }
